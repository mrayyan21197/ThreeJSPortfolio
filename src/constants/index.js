...
export const HERO_CONTENT = `I am a results-driven full stack developer with over 2 years of experience architecting cutting-edge web applications. I specialize in building high-impact digital products using React, Angular, Next.js, .NET, and automation technologies. With a relentless focus on performance, scalability, and user experience, I transform complex ideas into sleek, powerful solutions. I'm passionate about pushing boundaries, embracing innovation, and delivering technology that truly makes a difference.`;

export const ABOUT_TEXT = `I am a passionate and versatile full stack developer with 2 years of professional experience building modern, user-centric web applications. I specialize in crafting seamless solutions using React, Angular, Next.js, Node.js, .NET, n8n, make.com, and other cutting-edge technologies including automation tools. My expertise extends to creating sophisticated Voice Agents using make.com for intelligent customer interactions and implementing advanced Lead Generation systems that drive business growth. Over the years, I have worked on a variety of projects, including freelance platforms, blog websites, weather apps, enterprise-level management systems, and AI-powered automation solutions. My experience spans freelance work, internships at dynamic tech companies, and impactful research roles. I love turning ideas into reality through clean, efficient code and continuously seek to learn, innovate, and stay ahead in the fast-evolving tech world. When I'm not coding, you'll find me exploring new tech trends, designing side projects, or contributing to open-source communities.`;
